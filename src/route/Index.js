...
import HomePage from "../web_modules/navbar/Home";
import LearnPage from "../web_modules/navbar/Learn";
import PolicyPage from "../web_modules/navbar/Policy"
import TermsPage from "../web_modules/navbar/Terms"
      ...
      <Routes>
        ...
        <Route path={`${process.env.PUBLIC_URL}`} element={<LayoutNoSidebar />}>
          <Route path="auth-success" element={<Success />}></Route>
            ...
            <Route path="resume" element={<TransListCrypto />}></Route>
